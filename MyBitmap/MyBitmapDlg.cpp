...
CMyBitmapDlg::CMyBitmapDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MYBITMAP_DIALOG, pParent)
{
...
// CMyBitmapDlg 메시지 처리기

BOOL CMyBitmapDlg::OnInitDialog()
{
...
void CMyBitmapDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CMyBitmapDlg::OnQueryDragIcon()
{
